...
<pre lang="markdown"> ### 🛰️ 주요 행성과 그 위성 | 행성 | 대표 위성들 | |------------|------------------------------------------| | **지구** | Moon | | **화성** | Phobos, Deimos | | **목성** | Io, Europa, Ganymede, Callisto | | **토성** | Titan, Enceladus, Mimas, Rhea | | **천왕성** | Miranda, Ariel, Umbriel, Titania, Oberon | | **해왕성** | Triton, Nereid | | **왜행성** | Charon *(Pluto)* | </pre>
